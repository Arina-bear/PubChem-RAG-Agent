""" Модуль обеспечивает потокобезопасное хранение данных и автоматическую очистку устаревших записей, 
    используя примитивы синхронизации anyio для работы в высоконагруженных асинхронных средах """
import time
